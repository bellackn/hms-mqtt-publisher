...
impl<MQTT: MqttWrapper> MetricCollector for SimpleMqtt<MQTT> {
    fn publish(&mut self, hms_state: &HMSStateResponse) {
        ...
        let topic_payload_pairs = [
            (
                format!("hms800wt2/{inverter_id}/inverter_local_time"),
                inverter_local_time,
            ),
            (
                format!("hms800wt2/{inverter_id}/pv_current_power"),
                pv_current_power.to_string(),
            ),
            (
                format!("hms800wt2/{inverter_id}/pv_daily_yield"),
            ...
            (
                format!("hms800wt2/{inverter_id}/pv_grid_voltage"),
                pv_grid_voltage.to_string(),
            ),
            (
                format!("hms800wt2/{inverter_id}/pv_grid_freq"),
                pv_grid_freq.to_string(),
            ),
            (
                format!("hms800wt2/{inverter_id}/pv_inv_temperature"),
                pv_inv_temperature.to_string(),
            ),
            (
                format!("hms800wt2/{inverter_id}/pv_port1_voltage"),
                pv_port1_voltage.to_string(),
            ),
            (
                format!("hms800wt2/{inverter_id}/pv_port1_curr"),
                pv_port1_curr.to_string(),
            ),
            (
                format!("hms800wt2/{inverter_id}/pv_port1_power"),
                pv_port1_power.to_string(),
            ),
            (
                format!("hms800wt2/{inverter_id}/pv_port1_energy"),
                pv_port1_energy.to_string(),
            ),
            (
                format!("hms800wt2/{inverter_id}/pv_port1_daily_yield"),
                pv_port1_daily_yield.to_string(),
            ),
            (
                format!("hms800wt2/{inverter_id}/pv_port2_voltage"),
                pv_port2_voltage.to_string(),
            ),
            (
                format!("hms800wt2/{inverter_id}/pv_port2_curr"),
                pv_port2_curr.to_string(),
            ),
            (
                format!("hms800wt2/{inverter_id}/pv_port2_power"),
                pv_port2_power.to_string(),
            ),
            (
                format!("hms800wt2/{inverter_id}/pv_port2_energy"),
                pv_port2_energy.to_string(),
            ),
            (
                format!("hms800wt2/{inverter_id}/pv_port2_daily_yield"),
